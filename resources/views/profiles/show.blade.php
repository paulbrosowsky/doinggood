            ...
            <div class="flex flex-col items-center px-5">              
                ...
                <div class="mt-5 mb-2"> 
                    ...
                    <div class="flex flex-wrap">
                        @if(!$user->isUnlocked)
                            <svg class="h-6 fill-current mr-2 text-dg-red"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M376 186h-20v-40c0-55-45-100-100-100S156 91 156 146v40h-20c-22.002 0-40 17.998-40 40v200c0 22.002 17.998 40 40 40h240c22.002 0 40-17.998 40-40V226c0-22.002-17.998-40-40-40zM256 368c-22.002 0-40-17.998-40-40s17.998-40 40-40 40 17.998 40 40-17.998 40-40 40zm62.002-182H193.998v-40c0-34.004 28.003-62.002 62.002-62.002 34.004 0 62.002 27.998 62.002 62.002v40z"/></svg>           
                        @endif
                        ...
                        @if (isset($user->location))
                            <div class="flex items-center mb-5" >
                                ...
                                <div>
                                    ...
                                    <p class=" leading-none">{{$user->location}}</p>
                                </div>                                    
                            </div>
                        @endif 
            ...
            @foreach ($needs as $key => $chunk)   
                ...
                > 
                    @foreach ($chunk as $need)                 
                        <a href="{{ route('need', ['need' => $user->helper ? $need->need->id : $need->id]) }}">
                            <need-card             
                                class="mb-5"                             
                                :need="{{ $user->helper ? $need->need : $need }}"
                            ></need-card>
                        </a>
                    @endforeach  
                </masonry>   
