<template>
    <div class="relative">
        ...
        <div class="absolute top-0 right-0 z-20 text-dg-yellow bg-white rounded-full " v-if="user.helper">
            <svg class="fill-current" :class="iconSize" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
